...
namespace CompanyEmployees.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public IActionResult GetEmployeesForCompany(Guid companyId)
        {
            ...
            if (company == null)
            {
                _logger.LogInfo($"Company with id: {companyId} doesn't exist in the datatbase.");
                return NotFound();
            }
        ...
        public IActionResult GetEmployeerForCompany(Guid companyId, Guid id)
        {
            var company = _repository.Company.GetCompany(companyId, trackChanges: false);

            if(company == null)
            {
                _logger.LogInfo($"Company with id: {companyId}dosn't exist in the database.");
                return NotFound();
            }
